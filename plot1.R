#This code implements the PLOT1 as shown in the coursera Assignment 1 
...
hist(as.numeric(odfm$Global_active_power),main="Global Active Power ",xlab="Global Active Power (kilowatts)" ,col="red")
